...
const fcb = () => {
    return funcionesChatBot = {
        ...
        createChatTree: () => {
            ...
            funcionesChatBot.chatTree['0'] = {value: '¡Hola! soy GLIA su asistente virtual para orientarte frente a su salud mental.\n¿En qué temática le puedo ayudar?\n\n1) ¿Necesita Información? 📚\n2) ¿Necesita ayuda? 📋\n3) ¿Necesita radicar PQRS? 🤝\n\nEnvie @ en cualquier momento para volver al inicio'};

            funcionesChatBot.chatTree['1'] = {value: 'Necesita información sobre: \n1) Consumo de sustancias psicoactivas \n2) Trastornos mentales y epilepsia \n3) Violencia por razones de sexo y género \n4) Suicidio o ideación suicida \n#) Volver'};
            funcionesChatBot.chatTree['1']['1'] = {value: "Selecciona la temática de la cual desea obtener información: \n1) Sustancias psicoactivas ilícitas, tabaco y alcohol. \n2) Alcohol. \n\n#) Volver  \n@) Volver al inicio"};
            funcionesChatBot.chatTree['1']['1']['1'] = {value: "1) Te invitamos a conocer información de promoción y prevención frente al consumo de Sustancias psicoactivas ilícitas, tabaco y alcohol https://wwebjs.dev/guide/.  \n2) Selecciona si quieres contestar unas preguntas para conocer tu situación frente al consumo de Sustancias psicoactivas ilícitas, tabaco y alcohol: https://www.idsn.gov.co/ - O contáctenos a través de la línea amiga, donde será atendido por un profesional.  \nGracias por contactarnos, recuerda que estamos para ayudarte. Feliz día!  \n\n#) Volver  \n@) Volver al inicio"};
            funcionesChatBot.chatTree['1']['1']['2'] = {value: '1) Te invitamos a conocer información de promoción y prevención frente al consumo de alcohol https://wwebjs.dev/guide/. Gracias por contactarnos, recuerda que estamos para ayudarte. Feliz día!  \n2) Selecciona si quieres contestar unas preguntas para conocer tu situación frente al consumo de alcohol: https://www.idsn.gov.co/ - O contáctenos a través de la línea amiga, donde será atendido por un profesional.'};
