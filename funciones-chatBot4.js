...
const fcb = () => {
    return funcionesChatBot = {
        ...
        generarRutaRutaAnterior: () => {
            ...
            funcionesChatBot.raiz = funcionesChatBot.pos[0]
            ...
            console.log('Posicion raiz: ', +funcionesChatBot.pos[0]);    
            console.log('Posicion raiz atrás: ', +funcionesChatBot.pos[0] - 1);
            console.log('Last Pos: ', funcionesChatBot.lastPos); 
            console.log('Pos: ', funcionesChatBot.pos);
            console.log('Drop last item: ', funcionesChatBot.pos.splice(-1))
            console.log('PosAgain: ', funcionesChatBot.pos);
        },

        devolverse: () => {
            funcionesChatBot.raiz = funcionesChatBot.user.info.tree_pos.split('.');
            funcionesChatBot.raiz.splice(-1);
            funcionesChatBot.raiz;
            ...
            fs.writeFile('db/db' + funcionesChatBot.phoneNumber + '.json', JSON.stringify(funcionesChatBot.user), err => {
                if(err){
                    ...
                    console.log('Sending again: ' + eval(funcionesChatBot.key + '.value'));
...
/*         devolverArbol: () => {
            fs.write('db/db' + funcionesChatBot.phoneNumber + '.json', JSON.stringify(funcionesChatBot), err => {
                if(err){
                    console.log(err);
                } else {
